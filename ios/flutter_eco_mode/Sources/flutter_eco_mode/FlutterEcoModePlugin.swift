...
public class FlutterEcoModePlugin: NSObject, FlutterPlugin, EcoModeApi {
    ...
    // UNUSED: Event channel names not used by DevicePerformance
    ...
    // UNUSED: Flutter method call handler not needed
...
// UNUSED: All event stream handlers not used by DevicePerformance
...
// UNUSED: Battery monitoring helper not needed
...
// UNUSED: Connectivity stream handler not needed
